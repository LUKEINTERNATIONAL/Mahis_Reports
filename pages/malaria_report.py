...
source_example = {
    "Category": ["Confirmed Malaria Cases", "Presumed Malaria Cases", 
                "Confirmed malaria in pregnant women", "Presumed malaria in pregnant women"],
    "Under 5 Years": [120, 85, 15, 10],
    "Over 5 Years": [180, 120, 25, 15]
}
df = pd.DataFrame(source_example)
