...
def build_table(filtered):
    ...
    html.Tbody([
        ...
        html.Tr([html.Td(html.Strong("108")), html.Td("Number of OPD attendance"), html.Td(create_count(df=filtered), className="center")]),]),
    ...
    html.Tbody([
        ...
        html.Tr([html.Td(html.Strong("27")), html.Td("Sexually transmitted infections-new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="STI")), className="center")]),
        html.Tr([html.Td(html.Strong("29")), html.Td("Syphilis in pregnancy"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Syphilis in pregnancy")), className="center")]),
        html.Tr([html.Td(html.Strong("31")), html.Td("HIV confirmed positive (15-49 years) new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
        ...
        html.Tr([html.Td(html.Strong("58")), html.Td("Acute respiratory infections - new cases (U5)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Acute respiratory infection"))+
                                                                                                        int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Severe acute respiratory infection")), className="center")]),
        html.Tr([html.Td(html.Strong("60")), html.Td("Diarrhoea non-bloody -new cases (under5)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Diarrhea")), className="center")]),
        html.Tr([html.Td(html.Strong("64")), html.Td("Malnutrition - new case (under 5)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Malnutrition")), className="center")]),
        html.Tr([html.Td(html.Strong("69")), html.Td("Malaria - new cases (under 5)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Malaria", filter_col4="Age_Group", filter_value4="Under 5")), className="center")]),
        html.Tr([html.Td(html.Strong("70")), html.Td("Malaria - new cases (5 & over)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Malaria", filter_col4="Age_Group", filter_value4="Over 5")), className="center")]),
        html.Tr([html.Td(html.Strong("78")), html.Td("Neonatal tetanus - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Neonatal Tetanus")), className="center")]),
        html.Tr([html.Td(html.Strong("79")), html.Td("Cholera - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Cholera")), className="center")]),
        html.Tr([html.Td(html.Strong("81")), html.Td("Measles - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Measles")), className="center")]),
        html.Tr([html.Td(html.Strong("82")), html.Td("Acute Flaccid paralysis -confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Acute Flaccid paralysis")), className="center")]),
        html.Tr([html.Td(html.Strong("83")), html.Td("Ebola - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Ebola")), className="center")]),
        html.Tr([html.Td(html.Strong("84")), html.Td("Meningococal meningitis - confimed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Meningococcal meningitis")), className="center")]),
        html.Tr([html.Td(html.Strong("85")), html.Td("Plague - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Plague")), className="center")]),
        html.Tr([html.Td(html.Strong("86")), html.Td("Rabies - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Rabies")), className="center")]),
        html.Tr([html.Td(html.Strong("87")), html.Td("Yellow fever - confirmed new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Yellow Fever")), className="center")]),
        html.Tr([html.Td(html.Strong("88")), html.Td("Dysentery - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Dysentery")), className="center")]),
        html.Tr([html.Td(html.Strong("90")), html.Td("Eye infections - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Eye infection")), className="center")]),
        html.Tr([html.Td(html.Strong("91")), html.Td("Ear infections - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Ear infection nos")), className="center")]),
        html.Tr([html.Td(html.Strong("92")), html.Td("Skin infections - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Skin infections")), className="center")]),
        html.Tr([html.Td(html.Strong("93")), html.Td("Oral conditions"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
        ...
        html.Tr([html.Td(html.Strong("94")), html.Td("Schistosomiasis - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Schistosomiasis")), className="center")]),
        html.Tr([html.Td(html.Strong("95")), html.Td("Leprosy - new cases"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
                                                                                                        filter_col3="obs_value_coded",filter_value3="Leprosy")), className="center")]),
        html.Tr([html.Td(html.Strong("96")), html.Td("Common injuries and wounds (except RTA)"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
        ...
        html.Tr([html.Td(html.Strong("98")), html.Td("Number of road traffic accidents"), html.Td(int(create_count(df=filtered, filter_col1="Encounter",filter_value1="DIAGNOSIS",
                                                                                                        filter_col2="concept_name",filter_value2="Primary diagnosis",
