...
def build_table(filtered):
    ...
    html.Tbody([
        ...
        html.Tr([html.Td(html.Strong("108")), html.Td("Number of OPD attendance"), html.Td("Yes", className="center")]),]),
    ...
    html.Tbody([
        ...
        html.Tr([html.Td(html.Strong("27")), html.Td("Sexually transmitted infections-new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("29")), html.Td("Syphilis in pregnancy"), html.Td("2", className="center")]),
        html.Tr([html.Td(html.Strong("31")), html.Td("HIV confirmed positive (15-49 years) new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("37")), html.Td("Opportunistic infection - new cases"), html.Td("0", className="center")]),
        html.Tr([html.Td(html.Strong("58")), html.Td("Acute respiratory infections - new cases (U5)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("60")), html.Td("Diarrhoea non-bloody -new cases (under5)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("64")), html.Td("Malnutrition - new case (under 5)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("69")), html.Td("Malaria - new cases (under 5)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("70")), html.Td("Malaria - new cases (5 & over)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("78")), html.Td("Neonatal tetanus - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("79")), html.Td("Cholera - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("81")), html.Td("Measles - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("82")), html.Td("Acute Flaccid paralysis -confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("83")), html.Td("Ebola - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("84")), html.Td("Meningococal meningitis - confimed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("85")), html.Td("Plague - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("86")), html.Td("Rabies - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("87")), html.Td("Yellow fever - confirmed new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("88")), html.Td("Dysentery - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("90")), html.Td("Eye infections - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("91")), html.Td("Ear infections - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("92")), html.Td("Skin infections - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("93")), html.Td("Oral conditions"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("94")), html.Td("Schistosomiasis - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("95")), html.Td("Leprosy - new cases"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("96")), html.Td("Common injuries and wounds (except RTA)"), html.Td("Yes", className="center")]),
        html.Tr([html.Td(html.Strong("98")), html.Td("Number of road traffic accidents"), html.Td("Yes", className="center")]),]),
